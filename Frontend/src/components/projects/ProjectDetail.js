...
<div className="project-detail">
  <div className="row justify-content-center mb-4 text-center">
    ...
    <div className="col-12">
      <Link to="/projects" className="btn btn-secondary me-2 mb-2">
        Back to Projects
      </Link>
      {isOwner && (
        <>
          ...
          <button onClick={handleDeleteProject} className="btn btn-danger mb-2">
            Delete Project
          </button>
        </>
      )}
          ...
          <div className="col-12 col-md-6 mb-3">
            ...
            <p>
              ...
              <Link
                ...
                className="btn btn-sm btn-outline-primary ms-0 ms-md-2 mt-2"
              >
                Manage Members
              </Link>
            </p>
...
<div className="card mt-4 mb-4 mx-auto" style={{ maxWidth: '700px' }}>
...
<div className="d-flex justify-content-center">
  <div className="card" style={{ maxWidth: "900px", width: "100%" }}>
    <div className="card-header d-flex justify-content-center align-items-center">
      <h5 className="mb-4 me-3">Tasks</h5>
